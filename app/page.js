  ...
  useEffect(() => {
    ...
    const tour = new Shepherd.Tour({
      defaultStepOptions: {
        ...
        scrollToHandler: (el) => el.scrollIntoView({ behavior: 'smooth' }),
      }
    });
    ...
    tour.addStep({
      ...
      attachTo: { element: '.homeButton', on: 'top' },
    ...
    tour.addStep({
      ...
      attachTo: { element: '.launchableApps', on: 'bottom' },
      buttons: [
    ...
    tour.addStep({
      ...
      attachTo: { element: '.callButton', on: 'top' },
      buttons: [
        { text: 'Previous', action: tour.back },
        { text: 'Next', action: tour.next }
      ]
    ...
    tour.addStep({
      id: 'step4',
      text: 'Have something to say? Drop your thoughts by clicking this <strong>message button</strong>.',
      attachTo: { element: '.messageButton', on: 'top' },
      buttons: [
        { text: 'Previous', action: tour.back },
        { text: 'Next', action: tour.next }
      ]
    ...
    tour.addStep({
      ...
      attachTo: { element: '.profileButton', on: 'top' },
      buttons: [
        { text: 'Previous', action: tour.back },
        { text: 'Next', action: tour.next }
      ]
    ...
    tour.addStep({
      ...
      attachTo: { element: '.galleryButton', on: 'top' },
      buttons: [
        { text: 'Previous', action: tour.back },
        { text: 'Next', action: tour.next }
      ]
    ...
    tour.addStep({
      ...
      attachTo: { element: '.calendar', on: 'bottom' },
      buttons: [
        { text: 'Previous', action: tour.back },
    ...
    // Set flag when completed or canceled
    tour.on('complete', () => {
